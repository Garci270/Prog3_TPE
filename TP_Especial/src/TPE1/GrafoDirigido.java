...
public class GrafoDirigido<T> implements Grafo<T>{
	...
	/*La complejidad de tiempo total de la función findArco es O(n), ya que se itera sobre los arcos asociados al verticeId1. 
	 * La complejidad depende del número de arcos y no del tamaño total del grafo.*/
	...
	public boolean agregarArco(int v1, int v2) {
	...
	public Iterator<Integer> getAdyacentes(int verticeId){
	...
	//Getters y Setters
	/*La complejidad computacional es constante, es decir, O(1) para todos los getters y setters ya que Simplemente se accede y devuelve el valor o se setea el valor*/
